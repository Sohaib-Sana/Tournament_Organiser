...
class ActiveTournamentDetailsScreen extends StatefulWidget {
  static String id = 'ActiveTournamentDetailsScreen';
  const ActiveTournamentDetailsScreen({Key? key}) : super(key: key);

  @override
  State<ActiveTournamentDetailsScreen> createState() =>
      _ActiveTournamentDetailsScreenState();
}

class _ActiveTournamentDetailsScreenState
    extends State<ActiveTournamentDetailsScreen> {
  @override
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        child: CircleAvatar(
                          ...
                          backgroundImage:
                              const AssetImage('images/SmashSolo.png'),
                        ),
                      ),
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        ...
                        children: [
                          ...
                          SliderTheme(
                            data: SliderThemeData(
                              activeTrackColor: Color(0xffff6e00),
                              inactiveTrackColor:
                                  Color(0xffff6e00).withOpacity(0.3),
                            ...
                            child: Slider(
                              ...
                              onChanged: (double newValue) {
                                setState(
                                  () {
                                    _winProb = newValue.roundToDouble();
                                  },
                                );
                              },
                            ),
